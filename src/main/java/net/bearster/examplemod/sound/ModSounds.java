package net.bearster.examplemod.sound;
...
public class ModSounds {
    ...
    public static final ForgeSoundType MAGIC_BLOCK_SOUNDS = new ForgeSoundType(1f, 1f,
            ModSoundsGenerator.MAGIC_BLOCK_BREAK, ModSoundsGenerator.MAGIC_BLOCK_STEP, ModSoundsGenerator.MAGIC_BLOCK_PLACE,
            ModSoundsGenerator.MAGIC_BLOCK_HIT, ModSoundsGenerator.MAGIC_BLOCK_FALL);
