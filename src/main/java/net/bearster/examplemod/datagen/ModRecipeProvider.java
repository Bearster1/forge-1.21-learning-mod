...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ONION_SEEDS.get())
                ...
                .unlockedBy("has_onion",has(ModItems.ONION.get())).save(recipeOutput, MOD_ID+":onion_seeds_from_onion");
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ONION_SEEDS.get())
                ...
                .unlockedBy("has_azurite",has(ModItems.AZURITE.get())).save(recipeOutput, MOD_ID+":onion_seeds_from_azurite");
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.AZURITE.get(), 9)
                ...
                .unlockedBy("has_magic_block", has(ModBlocks.MAGIC_BLOCK.get())).save(recipeOutput, MOD_ID+":azurite_from_magic_block");
        ...
        trimSmithing(recipeOutput, ModItems.KAUPEN_SMITHING_TEMPLATE.get(), ResourceLocation.fromNamespaceAndPath(MOD_ID, "kaupen"));
