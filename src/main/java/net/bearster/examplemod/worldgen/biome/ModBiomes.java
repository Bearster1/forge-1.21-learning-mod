package net.bearster.examplemod.worldgen.biome;

import net.bearster.examplemod.ExampleMod;
import net.bearster.examplemod.worldgen.biome.region.NetherRegion;
import net.bearster.examplemod.worldgen.biome.region.OverworldRegion;
...
public class ModBiomes {
    ...
    public static void registerBiomes() {
        Regions.register(new OverworldRegion(ResourceLocation.fromNamespaceAndPath(MOD_ID, MOD_ID+"_overworld"), 20));
        Regions.register(new NetherRegion(ResourceLocation.fromNamespaceAndPath(MOD_ID, MOD_ID+"_nether"), 20));
