package net.bearster.examplemod.item;
...
import net.bearster.examplemod.item.custom.*;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> KAUPEN_SMITHING_TEMPLATE = ITEMS.register("kaupen_armor_trim_smithing_template",
            () -> SmithingTemplateItem.createArmorTrimTemplate(ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "kaupen")));
    ...
    public static final RegistryObject<Item> BAR_BRAWL_MUSIC_DISC = ITEMS.register("bar_brawl_music_disc",
            () -> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSoundsGenerator.BAR_BRAWL_KEY)));

    public static final RegistryObject<Item> J0J0JETZ_CLUB_MUSIC_DISC = ITEMS.register("j0j0jetz_club_music_disc",
            () -> new Item(new Item.Properties().stacksTo(1).jukeboxPlayable(ModSoundsGenerator.JOJOJETZ_CLUB_KEY)));
