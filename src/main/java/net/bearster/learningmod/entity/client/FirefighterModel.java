...
public class FirefighterModel extends HierarchicalModel<FirefighterEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -19.0F, -1.0F, 10.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition leftleg = body.addOrReplaceChild("leftleg", CubeListBuilder.create().texOffs(24, 24).addBox(2.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(14, 27).addBox(2.0F, -7.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition rightleg = body.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(0, 27).addBox(-4.0F, -2.0F, -3.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(28, 0).addBox(-4.0F, -7.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(30, 52).addBox(-4.0F, -26.0F, -4.0F, 8.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(0, 57).addBox(-3.0F, -28.0F, -3.0F, 6.0F, 2.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 16).addBox(-3.0F, -24.0F, -2.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
    ...
    public void setupAnim(FirefighterEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(FirefighterAnimations.ANIM_FIREFIGHTER_WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
